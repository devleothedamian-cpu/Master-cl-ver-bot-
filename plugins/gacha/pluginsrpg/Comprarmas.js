...
const handler = async (msg, { conn, args }) => {
  ...
  const sukirpgPath = path.join(process.cwd(), "masterpg.json");
  ...
  // Avatar del usuario
  let avatarURL = "https://files.catbox.moe/n9c1ja.jpeg";
  try {
  ...
  ctx.fillText("❦ FACTURA DE COMPRA MASTER CLOVER", 260, 60);
